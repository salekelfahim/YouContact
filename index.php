                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">Efficiency &middot; Simplicity &middot; Organization</div>
                            </div>
                            <div class="fs-3 fw-light text-muted">We can help you to</div>
                            <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Simplify contact management</span></h1>
                            <div
                                ...
                                <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                    href="sign.php">Sign Up</a>
                                <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" href="login.php">Log
                                    in</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="Assets/Images/11.png" alt="Pic" />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="lead fw-light mb-4">Simplify contact management with YouContact – we've got you covered..</p>
                            <p class="text-muted">YouContact is a user-friendly website designed to streamline the
                                management of your contacts. With a focus on simplicity and efficiency, YouContact
                                allows users to easily save, add, modify, and delete their contacts. Whether you're
                                organizing personal or professional connections, this platform provides a hassle-free
                                experience for keeping your contact list up-to-date and easily accessible. Say goodbye
                                to contact management headaches with YouContact's intuitive interface and essential
                                features.</p>
