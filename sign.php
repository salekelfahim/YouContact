              ...
              <form action="Assets/PHP/register.php" method="POST">
                ...
                <div class="row">
                  <div class="col-6 w-100 mb-3">
                    <div class="input-group d-flex w-100">
                      <input type="password" class="form-control w-100" name="passwordd" placeholder="Password" aria-label="password" aria-describedby="password" id="password-input" />
                ...
                <div class="d-none" id="submitSuccessMessage">
                  <div class="text-center mb-3">
                    <div class="fw-bolder">You had sign up successfully!</div>
                    <br />
                  </div>
                </div>
                <div class="d-none" id="submitErrorMessage">
                  <div class="text-center text-danger mb-3">Error signing up!</div>
                </div>
                <!-- Submit Button-->
                <!-- <div class="d-grid"><button class="btn btn-primary btn-lg disabled" id="submitButton" type="submit">Sign Up</button></div> -->
                <button type="Submit" name="adduser" class="btn btn-primary">Add Contact</button>
              </form>
            </div>
          </div>
        </div>
